...
export const demoListings: Listing[] = [
  ...
  {
    id: 21, category: "Airbnb", title: "Casa patio en el centro histórico", location: "Barranco, Lima", description: "Casa con patio interior, detalles locales y todo lo necesario para una escapada con personalidad.", image: image("photo-1497366754035-f200968a6e72"), price: 240, priceLabel: "por noche", rating: 4.98, reviews: 46, meta: "2 huéspedes · 1 habitación · Wifi", badge: "Favorito entre huéspedes", ownerName: "Sofía", ownerWhatsApp: "51999888777",
  },
  {
    id: 22, category: "Airbnb", title: "Atardecer frente al mar", location: "Miraflores, Lima", description: "Un refugio con balcón, cama king y acceso caminando al malecón y los mejores cafés.", image: image("photo-1510798831971-661eb04b3739"), price: 380, priceLabel: "por noche", rating: 4.96, reviews: 32, meta: "2 huéspedes · 1 habitación · Vista al mar", badge: "Reserva flexible", ownerName: "Camila", ownerWhatsApp: "51992223344",
  },
  {
    id: 23, category: "Airbnb", title: "Loft verde para desconectar", location: "Cieneguilla, Lima", description: "Loft rodeado de verde para bajar el ritmo, leer y compartir una estadía diferente.", image: image("photo-1449158743715-0a90ebb6d2d8"), price: 420, priceLabel: "por noche", rating: 4.9, reviews: 19, meta: "4 huéspedes · 2 habitaciones · Piscina", ownerName: "Nicolás", ownerWhatsApp: "51995556677",
  },
  {
    id: 24, category: "Airbnb", title: "Mini depa con diseño local", location: "Centro de Lima", description: "Un espacio compacto, bonito y funcional para conocer la ciudad desde el corazón.", image: image("photo-1505693416388-ac5ce068fe85"), price: 190, priceLabel: "por noche", rating: 4.85, reviews: 27, meta: "2 huéspedes · 1 habitación · Cocina", ownerName: "Mariana", ownerWhatsApp: "51991119911",
  },
  {
